	...
	class WPCplant_WooCommerce {
		...
		public function woocommerce_scripts() {
			...
			if ( class_exists( 'WPCleverWoosc' ) ) {
				wp_enqueue_script( 'wpcplant-compare-addon', get_template_directory_uri() . '/assets/js/woocommerce/extensions/compare' . $suffix . '.js', array( 'jquery' ), $wpcplant_version, true );
			}
		}
