 ...
 * Header
 *
 * @see wpcplant_header_search()
 * @see wpcplant_header_wishlist()
 * @see wpcplant_header_cart()
 */
add_action( 'wpcplant_header', 'wpcplant_header_search', 15 );
add_action( 'wpcplant_header', 'wpcplant_header_compare', 25 );
add_action( 'wpcplant_header', 'wpcplant_header_wishlist', 28 );
